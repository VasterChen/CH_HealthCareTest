...
(defrule binding-rule-1
    ...
    (bind-input-table time-sample (attribute sample-rate-micro-seconds 1000) (attribute callstack (if (eq (nth$ 1 ?needs-kernel-callstack) 1) then (create$ user kernel) else (create$ user))) (attribute target $?target) (attribute all-thread-states YES))
...
(defrule binding-rule-2
    ...
    (bind-input-table time-sample (attribute sample-rate-micro-seconds 100) (attribute target $?target) (attribute callstack (if (eq (nth$ 1 ?needs-kernel-callstack) 1) then (create$ user kernel) else (create$ user))))
    (assert (modeler-instance-param (instance ?instance__) (name high-freq) (value ?high-freq)))
    (assert (modeler-instance-param (instance ?instance__) (name needs-kernel-callstack) (value ?needs-kernel-callstack)))
    (assert (modeler-instance-param (instance ?instance__) (name target) (value ?target)))
    (assert (modeler-instance-param (instance ?instance__) (name record-waiting-threads) (value ?record-waiting-threads)))
...
(defrule binding-rule-4
    ...
    (bind-input-table time-sample (attribute sample-rate-micro-seconds 1000) (attribute target $?target) (attribute all-thread-states (if (eq (nth$ 1 ?record-waiting-threads) 1) then YES else NO)) (attribute callstack (if (eq (nth$ 1 ?needs-kernel-callstack) 1) then (create$ user kernel) else (create$ user))))
    (assert (modeler-instance-param (instance ?instance__) (name target) (value ?target)))
    (assert (modeler-instance-param (instance ?instance__) (name needs-kernel-callstack) (value ?needs-kernel-callstack)))
    (assert (modeler-instance-param (instance ?instance__) (name record-waiting-threads) (value ?record-waiting-threads)))
)
